...
% <gradient_function> is a function that takes parameters <model> and <data> and returns 
% the gradient (or approximate gradient in the case of CD-1) of the function that we're maximizing. 
